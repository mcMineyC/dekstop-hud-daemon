...
integration.fetchers = {
  "/position": async () => await player.getPosition(),
  "/metadata": async () => await player.getMetadata(),
  "/playbackState": async () => await player.getPlaybackState(),
}
...
player.on('positionChanged', (position) => integration.publishData("/position", position))
